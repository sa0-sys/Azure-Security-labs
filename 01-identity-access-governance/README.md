...
| Azure Key Vault — defense in depth | Access policies vs RBAC, secrets, keys, certificates | ✅ Completed |
| Azure Policy & governance | Policy definitions, initiatives, enforce tagging & allowed regions, regulatory compliance | ✅ Completed |
